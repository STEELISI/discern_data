...
These datasets are created by DISCERN project's members on the [SPHERE research infrastructure](https://sphere-testbed.net).
They are contained in the [synthetic](synthetic) folder.
